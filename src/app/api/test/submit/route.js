  ...
  try {
    ...
    return NextResponse.json({
      ...
      relation: relationRecord ? {
        ...
        hostId: relationRecord.hostId,
        hostName: relationRecord.hostName || hostName,
        hostMbti: relationRecord.hostMbti,
        hostZodiac: relationRecord.hostZodiac,
        hostRole: relationRecord.hostRole,
        hostMood: relationRecord.hostMood,
        guestId: relationRecord.guestId,
        guestName: relationRecord.guestName,
        guestMbti: relationRecord.guestMbti,
        guestZodiac: relationRecord.guestZodiac,
        guestRole: relationRecord.guestRole,
        guestMood: relationRecord.guestMood,
